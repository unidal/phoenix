...
public class SortToolTest {
	...
	private static List<SortElement> sortElementList;
	private static List<SortElement> expectedElementList;
	
	@BeforeClass
	public static void init(){
		sortElementList = new ArrayList<SortElement>();
		expectedElementList = new ArrayList<SortElement>();
	...
	public void sortTest(){
		List<SortElement>  sel = SortTool.sort(sortElementList);
		Assert.assertArrayEquals(expectedElementList.toArray(), sel.toArray());
		for(SortElement se : sel){
