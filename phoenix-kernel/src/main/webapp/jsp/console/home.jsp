...
<jsp:useBean id="ctx" type="com.dianping.kernel.console.page.home.Context" scope="request"/>
<jsp:useBean id="payload" type="com.dianping.kernel.console.page.home.Payload" scope="request"/>
<jsp:useBean id="model" type="com.dianping.kernel.console.page.home.Model" scope="request"/>
