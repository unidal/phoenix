...
public class ProxyStandardContext extends StandardContext {
	...
	public int getCacheObjectMaxSize() {
		...
		return m_standardContext.getCacheObjectMaxSize();
	}
	...
	public boolean getClearReferencesStopThreads() {
		...
		return m_standardContext.getClearReferencesStopThreads();
	}

	@Override
	public boolean getClearReferencesStopTimerThreads() {

		return m_standardContext.getClearReferencesStopTimerThreads();
	}

	@Override
	public boolean getClearReferencesThreadLocals() {

		return m_standardContext.getClearReferencesThreadLocals();
	}
	...
	public String getSessionCookieDomain() {
		...
		return m_standardContext.getSessionCookieDomain();
	}

	@Override
	public String getSessionCookieName() {

		return m_standardContext.getSessionCookieName();
	}

	@Override
	public String getSessionCookiePath() {

		return m_standardContext.getSessionCookiePath();
	}
	...
	public boolean getUseHttpOnly() {
		...
		return m_standardContext.getUseHttpOnly();
	}
	...
	public void setCacheObjectMaxSize(int cacheObjectMaxSize) {
		dualInvoke(cacheObjectMaxSize);
		m_standardContext.setCacheObjectMaxSize(cacheObjectMaxSize);
	}
	...
	public void setClearReferencesStopThreads(boolean clearReferencesStopThreads) {
		dualInvoke(clearReferencesStopThreads);
		m_standardContext.setClearReferencesStopThreads(clearReferencesStopThreads);
	}

	@Override
	public void setClearReferencesStopTimerThreads(boolean clearReferencesStopTimerThreads) {
		dualInvoke(clearReferencesStopTimerThreads);
		m_standardContext.setClearReferencesStopTimerThreads(clearReferencesStopTimerThreads);
	}

	@Override
	public void setClearReferencesThreadLocals(boolean clearReferencesThreadLocals) {
		dualInvoke(clearReferencesThreadLocals);
		m_standardContext.setClearReferencesThreadLocals(clearReferencesThreadLocals);
	}
	...
	public void setSessionCookieDomain(String sessionCookieDomain) {
		dualInvoke(sessionCookieDomain);
		m_standardContext.setSessionCookieDomain(sessionCookieDomain);
	}

	@Override
	public void setSessionCookieName(String sessionCookieName) {
		dualInvoke(sessionCookieName);
		m_standardContext.setSessionCookieName(sessionCookieName);
	}

	@Override
	public void setSessionCookiePath(String sessionCookiePath) {
		dualInvoke(sessionCookiePath);
		m_standardContext.setSessionCookiePath(sessionCookiePath);
	}
	...
	public void setUseHttpOnly(boolean useHttpOnly) {
		dualInvoke(useHttpOnly);
		m_standardContext.setUseHttpOnly(useHttpOnly);
	}
