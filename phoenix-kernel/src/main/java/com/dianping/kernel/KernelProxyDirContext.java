...
public class KernelProxyDirContext implements DirContext{
	
	private DirContext appContext;
	private DirContext kernelContext;
	
	public KernelProxyDirContext(DirContext appContext,DirContext kernelContext){
	...
	public NamingEnumeration<SearchResult> search(Name name,
		...
		try{
			return this.appContext.search( name,
					 matchingAttributes);
		}catch(NamingException e){
			try{
				return this.kernelContext.search( name,
						 matchingAttributes);
			}catch(NamingException e1){
				throw e;
			}
	...
	public NamingEnumeration<SearchResult> search(Name name, String filterExpr,
		...
		try{
			return this.appContext.search( name,  filterExpr,
					 filterArgs,  cons);
		}catch(NamingException e){
			try{
				return this.kernelContext.search( name,  filterExpr,
						 filterArgs,  cons);
			}catch(NamingException e1){
				throw e;
			}
