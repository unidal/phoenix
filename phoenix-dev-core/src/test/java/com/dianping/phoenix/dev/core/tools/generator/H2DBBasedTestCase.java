 ...
 * 
 */
public abstract class H2DBBasedTestCase {
    ...
    private List<DBDataEntry> parseDataFile() throws Exception {
        ...
        Document configDoc = builder.parse(this.getClass().getResourceAsStream(getDataFile()));
    ...
    private void parseCreateScriptConfigFile() throws Exception {
        DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
        DocumentBuilder builder = factory.newDocumentBuilder();
        Document configDoc = builder.parse(this.getClass().getResourceAsStream(getCreateScriptConfigFile()));
        XPathFactory xpathFactory = XPathFactory.newInstance();
        XPath xpath = xpathFactory.newXPath();
