...
final class PhoenixDatabaseConfigurator extends AbstractJdbcResourceConfigurator {
   ...
   public List<Component> defineComponents() {
      ...
      all.add(defineJdbcDataSourceComponent("phoenix", "com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/phoenix", "root", "12qwaszx", "<![CDATA[useUnicode=true&autoReconnect=true]]>"));
