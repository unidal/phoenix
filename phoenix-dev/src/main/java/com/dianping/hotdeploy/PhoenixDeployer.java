package com.dianping.hotdeploy;
...
public class PhoenixDeployer {
	private static final Logger LOGGER = Logger.getLogger(PhoenixDeployer.class);
	...
	public PhoenixDeployer(ClassLoader cl) {
		if (cl == null) {
