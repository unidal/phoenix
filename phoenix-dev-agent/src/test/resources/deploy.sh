...
expect "*]*"
send "mkdir -p /data/webapps/phoenix-dev-agent/phoenix.war/\r"
expect "*]*"
send "mkdir -p /data/webapps/phoenix-dev/\r"
expect "*]*"
send "chown nobody:nobody -R /data/webapps/phoenix-dev/\r"
expect "*]*"
send "chown nobody:nobody -R /data/webapps/phoenix-dev-agent/\r"
expect "*]*"
