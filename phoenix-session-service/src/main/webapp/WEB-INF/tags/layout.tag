...
<jsp:useBean id="navBar" class="com.dianping.platform.session.view.NavigationBar" scope="page" />

<!DOCTYPE html>
<html lang="en">

<head>
	<title>Session - ${model.page.description}</title>
...
<body data-spy="scroll" data-target=".subnav" data-offset="50">
	...
	<div class="container-fluid" style="min-height:524px;">
		...
		<br />
		<div class="container">
			<footer><center>&copy;2013 Dianping Session Team</center></footer>
		</div>
	</div>
	<!--/.fluid-container-->
